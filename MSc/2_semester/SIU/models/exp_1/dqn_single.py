...
class DqnSingle():
    ...
    def __init__(self,env:TurtlesimEnvBase,id_prefix='dqns2',seed=42):
        self.env=env
        ...
        self.EPISODES_MAX=6000              #*P liczba epizodów uczących
...
if __name__ == "__main__":
    ...
    # Continue training
    loaded_model_episode = 3950
    dqns.model=load_model(f"models/dqns2_model_{loaded_model_episode}.tf")           # albo załadowanie zapisanej wcześniej
