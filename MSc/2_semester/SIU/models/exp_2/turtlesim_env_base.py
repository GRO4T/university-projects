...
class TurtlesimEnvBase(metaclass=abc.ABCMeta):
    ...
    def __init__(self):
        ...
        self.SPEED_RWRD_RATE = 6.0      #>wzmocnienie nagrody za jazdę w kierunku # zmienilem
        self.SPEED_RVRS_RATE = -14.0    #<wzmocnienie kary za jazdę pod prąd
        ...
        self.OUT_OF_TRACK_FINE = -15    #<ryczałtowa kara za wypadnięcie z trasy
