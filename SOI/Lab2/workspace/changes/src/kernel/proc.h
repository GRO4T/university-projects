...
struct proc {
  ...
  int ptype;
  int base_pri;			/* additional priorities for the purpose of aging scheduling*/
  int act_pri;
  int prev_act_pri;
...
#define isonep(p)	  ((p)->ptype == 1)	/* <modified> */
#define istwop(p)         ((p)->ptype == 2)
#define isthreep(p)       ((p)->ptype == 3)
