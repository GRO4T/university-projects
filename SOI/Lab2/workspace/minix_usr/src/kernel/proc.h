...
#define PPRI_1		4	/* <modified> */
#define PPRI_2		5
#define PPRI_3		6
#define PPRI_IDLE	7	/* Idle process */
...
#define is1p(p)	          ((p)->p_priority == PPRI_1)	/* <modified> */
#define is2p(p)		  ((p)->p_priority == PPRI_2)
#define is3p(p)		  ((p)->p_priority == PPRI_3)
