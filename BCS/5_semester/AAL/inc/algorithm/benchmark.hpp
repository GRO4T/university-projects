#ifndef ROBOTGUI_BENCHMARK_HPP
#define ROBOTGUI_BENCHMARK_HPP
...
// Code from:
// http://jakascorner.com/blog/2016/04/time-measurement.html?fbclid=IwAR3TJLXePq4A0LrzYawSGCe6H3QSIRk1HF1pZFQuqYJkP_CmcwVp2bQ9tAc

template <typename TimeT = std::chrono::microseconds>
class Benchmark {
public:
    Benchmark(int num_iterations = 100, int throw_away = 0)
        : m_num_iter(num_iterations), m_throw_away(throw_away), m_times(), m_mean(), m_st_dev() {}
